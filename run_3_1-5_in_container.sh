...
echo "[INFO] コンテナ内で 3_1-5_check_asn_correctness.sh を実行します."
...
docker run --rm \
  ...
  -e RPKI_LOG_FILE="${RPKI_LOG_FILE:-/work/3_1-5_check_asn_correctness.log}" \
  ...
  -lc "bash /work/3_1-5_check_asn_correctness.sh"
